...
self.addEventListener('install', function (event) {
  console.log('Installing Service Worker ...'); // TODO: Caching App Shell Resource
...
self.addEventListener('activate', function (event) {
  console.log('Activating Service Worker ...'); // TODO: Delete old caches
